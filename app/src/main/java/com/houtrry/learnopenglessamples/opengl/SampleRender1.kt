...
class SampleRender1(private val context: Context) : Renderer {
    ...
    private val tableVertices = floatArrayOf(
        ...
        -0.52f, -0.51f,     0.7f, 0.7f, 1.0f,
        -0.52f,  0.51f,     0.7f, 1.0f, 0.7f,
         0.52f,  0.51f,     1.0f, 0.7f, 0.7f,
         0.52f, -0.51f,     0.7f, 1.0f, 0.7f,
        -0.52f, -0.51f,     0.7f, 0.7f, 1.0f,
    ...
    private fun initProgram() {
        val simpleVertexShader = context.readRawText(R.raw.simple_vertex_shader1)
        val simpleFragmentShader = context.readRawText(R.raw.simple_fragment_shader1)
